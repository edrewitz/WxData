---
title: FEMS Multi RAWS Station Fuels Observations
---
[***Return To WxData Wiki Main Page***](https://github.com/edrewitz/WxData/wiki)
# FEMS: Multi RAWS Station Fuels Observations
```python
...
6) clear_recycle_bin (Boolean) - Default=False. When set to True, the contents in your recycle/trash bin will be deleted 
    with each run of the program you are calling WxData. This setting is to help preserve memory on the machine. 
    
7) path (String) - Default=f'{folder_modified}/FEMS Data/Multi Station/Observations/Fuels'. 
