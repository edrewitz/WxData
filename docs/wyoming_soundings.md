---
title: Observed Atmospheric Soundings
---
...
Some stations only have the ID by integer. Please see [https://weather.uwyo.edu/upperair/sounding.shtml](https://weather.uwyo.edu/upperair/sounding.shtml) for more info. 
