...
def ecmwf_ifs_url_scanner(final_forecast_hour):
    ...
    if final_forecast_hour >= 144:
        file_18z_today = f"{now.strftime('%Y%m%d')}180000-144h-scda-fc.grib2"
        file_06z_today = f"{now.strftime('%Y%m%d')}060000-144h-scda-fc.grib2"
        file_18z_yesterday = f"{yd.strftime('%Y%m%d')}180000-144h-scda-fc.grib2"
        file_06z_yesterday = f"{yd.strftime('%Y%m%d')}060000-144h-scda-fc.grib2"
    else:
...
def ecmwf_ifs_ens_url_scanner(final_forecast_hour):
    ...
    file_12z_yesterday = f"{yd.strftime('%Y%m%d')}120000-{final_forecast_hour}h-enfo-ef.grib2"
    file_00z_yesterday = f"{yd.strftime('%Y%m%d')}000000-{final_forecast_hour}h-enfo-ef.grib2"
    if final_forecast_hour >= 144:
        file_18z_today = f"{now.strftime('%Y%m%d')}180000-144h-enfo-ef.grib2"
        file_06z_today = f"{now.strftime('%Y%m%d')}060000-144h-enfo-ef.grib2"
        file_18z_yesterday = f"{yd.strftime('%Y%m%d')}180000-144h-enfo-ef.grib2"
        file_06z_yesterday = f"{yd.strftime('%Y%m%d')}060000-144h-enfo-ef.grib2"
    else:
        file_18z_today = f"{now.strftime('%Y%m%d')}180000-{final_forecast_hour}h-enfo-ef.grib2"
        file_06z_today = f"{now.strftime('%Y%m%d')}060000-{final_forecast_hour}h-enfo-ef.grib2"
        file_18z_yesterday = f"{yd.strftime('%Y%m%d')}180000-{final_forecast_hour}h-enfo-ef.grib2"
...
def ecmwf_aifs_ens_url_scanner(final_forecast_hour,
    ...
    file_06z_today = f"{now.strftime('%Y%m%d')}060000-{final_forecast_hour}h-enfo-{cat}.grib2"
    file_00z_today = f"{now.strftime('%Y%m%d')}000000-{final_forecast_hour}h-enfo-{cat}.grib2"
    file_18z_yesterday = f"{yd.strftime('%Y%m%d')}180000-{final_forecast_hour}h-enfo-{cat}.grib2"
    file_12z_yesterday = f"{yd.strftime('%Y%m%d')}120000-{final_forecast_hour}h-enfo-{cat}.grib2"
    file_06z_yesterday = f"{yd.strftime('%Y%m%d')}060000-{final_forecast_hour}h-enfo-{cat}.grib2"
...
def ecmwf_ifs_wave_url_scanner(final_forecast_hour):
    ...
    if final_forecast_hour > 360:
        print("""
              ERROR: The ECMWF IFS WAVE goes out to 360 hours. 
              You entered a final_forecast_hour > 360. 
              Defaulting to 360 as the final_forecast_hour.  
              """)
    ...
    file_00z_today = f"{now.strftime('%Y%m%d')}000000-{final_forecast_hour}h-wave-fc.grib2"
    file_18z_yesterday = f"{yd.strftime('%Y%m%d')}180000-{final_forecast_hour}h-scwv-fc.grib2"
    file_12z_yesterday = f"{yd.strftime('%Y%m%d')}120000-{final_forecast_hour}h-wave-fc.grib2"
...
def ecmwf_ifs_wave_ens_url_scanner(final_forecast_hour):
    ...
    if final_forecast_hour > 360:
        print("""
              ERROR: The ECMWF IFS-ENSEMBLE WAVE goes out to 360 hours. 
              You entered a final_forecast_hour > 360. 
              Defaulting to 360 as the final_forecast_hour.  
              """)
    ...
    file_06z_today = f"{now.strftime('%Y%m%d')}060000-{final_forecast_hour}h-waef-ef.grib2"
    file_00z_today = f"{now.strftime('%Y%m%d')}000000-{final_forecast_hour}h-waef-ef.grib2"
    file_18z_yesterday = f"{yd.strftime('%Y%m%d')}180000-{final_forecast_hour}h-waef-ef.grib2"
    file_12z_yesterday = f"{yd.strftime('%Y%m%d')}120000-{final_forecast_hour}h-waef-ef.grib2"
    file_06z_yesterday = f"{yd.strftime('%Y%m%d')}060000-{final_forecast_hour}h-waef-ef.grib2"
