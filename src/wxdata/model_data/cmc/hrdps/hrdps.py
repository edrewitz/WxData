"""
This file hosts the functions for the HRDPS Data Client
...
def _hrdps_client(final_forecast_hour=48, 
             step=1,
             path=f"HRDPS",
             proxies=None, 
             chunk_size=8192,
    ...
    1) final_forecast_hour (Integer) - Default = 48. The final forecast hour the user wishes to download. The HRDPS
        ...
        48 by the nereast increment of 1 hours. 
    ...
    ***Variables & Proper level_type & level***
    ...
    variable_key = _hrdps_variable_keys(variable)
    ...
    if level_type == 'pressure' or level_type == 'height above ground' or level_type == 'potential vorticity surface':
        ...
        print(f"Scanning https://dd.weather.gc.ca/ HRDPS {variable.upper()} {level}{suffix}")
        print("Please Wait...")
        urls, files = _hrdps_url_scanner(final_forecast_hour,
                            proxies,
                            level_type,
                            variable_key,
                            step,
        ...
        if download == True or clear_data == True:
            ...
            print(f"HRDPS {variable.upper()} {level}{suffix} Download Complete!\n")   
        else:
            print(f"HRDPS {variable.upper()} {level}{suffix} data on local machine is up to date with latest data on the server.\nSkipping Download.\n")
        ...
        print(f"Scanning https://dd.weather.gc.ca/ HRDPS {variable.upper()} {ext}")
        print("Please Wait...")
        urls, files = _hrdps_url_scanner(final_forecast_hour,
                            proxies,
                            level_type,
        ...
        if download == True or clear_data == True:
            ...
            for url, file in zip(urls, files):
                _client.get_gridded_data(url,
                                        ...
                                        chunk_size=chunk_size,
                                        notifications=notifications)
            print(f"HRDPS {variable.upper()} {ext} Download Complete!\n")   
        else:
            print(f"HRDPS {variable.upper()} {ext} data on local machine is up to date with latest data on the server.\nSkipping Download.\n")
        ...
        if download == True or clear_data == True:
            ...
            for url, file in zip(urls, files):
                _client.get_gridded_data(url,
                                        ...
                                        chunk_size=chunk_size,
                                        notifications=notifications)
            print(f"HRDPS {variable.upper()} {level_type} Download Complete!\n")   
        else:
            print(f"HRDPS {variable.upper()} {level_type} data on local machine is up to date with latest data on the server.\nSkipping Download.\n")
...
def hrdps(final_forecast_hour=48, 
    ...
    ***Variables & Proper level_type & level***
    ...
    if level_type == 'pressure' or level_type == 'height above ground' or level_type == 'potential vorticity surface':
        ...
        dir = _hrdps_client(final_forecast_hour=final_forecast_hour, 
                    step=step,
                    path=path,
                    proxies=proxies, 
                    chunk_size=chunk_size,
    ...
    if process_data == True:
        ...
        ds = _cmc_post_processing.hrdps_post_processing(dir,
                                                        variable)
        ...
        if level_type == 'pressure' or level_type == 'height above ground' or level_type == 'potential vorticity surface':
            print(f"HRDPS Data Processing Complete: {variable.upper()} - {level}mb")
        elif level_type == 'pressure layer' or level_type == 'depth below surface':
            if level_type == 'pressure layer':
                print(f"HRDPS Data Processing Complete: {variable.upper()} - {layer[0]}to{layer[1]}mb")
            else:
