...
from wxdata.model_data.noaa.cfs.url_scanners import(
...
def _cfs_flux_client(western_bound=-180, 
            eastern_bound=180, 
            northern_bound=90, 
            southern_bound=-90, 
...
def _cfs_pressure_client(western_bound=-180, 
            eastern_bound=180, 
            northern_bound=90, 
            southern_bound=-90, 
            final_forecast_hour=720,
...
def cfs_flux(western_bound=-180, 
    ...
    ***CFS Flux Data Variables In Plain-Language Format***
    ...
    try:
        if process_data == True:
            ds = _cfs_flux_client(western_bound=western_bound, 
            ...
            _cfs_flux_client(western_bound=western_bound, 
                        eastern_bound=eastern_bound, 
                        northern_bound=northern_bound, 
                        southern_bound=southern_bound, 
                        final_forecast_hour=final_forecast_hour,
    ...
    ***CFS Pressure Data Variables In Plain-Language Format***
    ...
    try:
        if process_data == True:
            ...
            _cfs_pressure_client(western_bound=western_bound, 
                                        eastern_bound=eastern_bound, 
                                        northern_bound=northern_bound, 
                                        southern_bound=southern_bound, 
                                        final_forecast_hour=final_forecast_hour,
